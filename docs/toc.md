...
全书规划为五篇、00–24 共 25 章，围绕同一个文档维护助手递进。基础路线是 **00–17 → 24**；18–23 为可选分支。

当前开放第一部分 00–03、01 Rust 对照及阶段汇总 1。它们是文字修订稿，真实模型、读者跟做和章节快照仍待验收。其余新版章节在本次发布中仅列出规划；04–06 的链接提供待发布说明。
