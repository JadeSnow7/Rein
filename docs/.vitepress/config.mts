    ...
    sidebar: {
      '/': [
        ...
        { text: '第一阶段 · 直觉', collapsed: false, items: [
          { text: '00 绪论', link: '/chapters/00.html' }, { text: '阅读材料 0 · 公共导读', link: '/readings/00.html' }, { text: '阅读材料 0 · TypeScript 版', link: '/readings/00-ts.html' }, { text: '阅读材料 0 · Rust 版', link: '/readings/00-rust.html' }, { text: '01 从模型调用开始', link: '/chapters/01.html' }, { text: '02 写一份合格的提示词', link: '/chapters/02.html' }, { text: '阅读材料 1', link: '/readings/01.html' }, { text: '03 工具调用', link: '/chapters/03.html' }, { text: '小结', link: '/milestones/01.html' }
        ] },
